...
export class AdminComponent implements OnInit {
	...
	constructor(
		...
		this.orders$ = this.onGetTotalOrdersCollection(this.startDate, this.endDate);
		let itemSubs = this.orders$.subscribe((res) => {
			if (!this.isFirstTime && res.length > this.itemLength) this.notificationAudio.play();
	...
	onGetTotalOrdersCollection(startDate: Date, endDate: number): Observable<any> {
